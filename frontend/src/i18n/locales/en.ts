  ...
  admin: {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        endpointHint: 'Accepts an origin (e.g. https://api.example.com) or a URL with a path prefix (e.g. https://gateway.com/model-farm/vllm_api). Query string and fragment are not allowed.',
        endpointJoinIntro: 'The check call appends this path to your endpoint:',
        endpointJoinPreviewLabel: 'Effective request URL:',
        endpointJoinPreviewPlaceholder: '(fill the endpoint above to preview)',
        apiKey: 'API Key',
        apiKeyPlaceholder: 'Enter API Key',
